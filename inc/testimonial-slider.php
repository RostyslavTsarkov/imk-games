...
add_shortcode('testimonial-slider', function () {
    ...
    <div id="testimonial-slider" class="slick-slider home-slider testimonial-slider">
        <img class="testimonial-slider__border-img" src="<?php echo asset_path('images/decoration/testimonials-border.png') ?>">
        <img class="testimonial-slider__substrate" src="<?php echo asset_path('images/decoration/testimonials-substrate.png') ?>">
        <?php foreach (get_field('home_featured_testimonials') as $post) :
            setup_postdata($post); ?>
